...
${OBJECTDIR}/src/config.o: src/config.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/config.o src/config.cpp

${OBJECTDIR}/src/db-code.o: src/db-code.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/db-code.o src/db-code.cpp

${OBJECTDIR}/src/device-table.o: src/device-table.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/device-table.o src/device-table.cpp

${OBJECTDIR}/src/fda.o: src/fda.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/fda.o src/fda.cpp

${OBJECTDIR}/src/fields-input-iterator.o: src/fields-input-iterator.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/fields-input-iterator.o src/fields-input-iterator.cpp

${OBJECTDIR}/src/input_validator.o: src/input_validator.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/input_validator.o src/input_validator.cpp

${OBJECTDIR}/src/maude-ifstream.o: src/maude-ifstream.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/maude-ifstream.o src/maude-ifstream.cpp

${OBJECTDIR}/src/mdr-report-key.o: src/mdr-report-key.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/mdr-report-key.o src/mdr-report-key.cpp

${OBJECTDIR}/src/mdr-table.o: src/mdr-table.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/mdr-table.o src/mdr-table.cpp

${OBJECTDIR}/src/medwatch-table.o: src/medwatch-table.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/medwatch-table.o src/medwatch-table.cpp

${OBJECTDIR}/src/table-factory.o: src/table-factory.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/table-factory.o src/table-factory.cpp

${OBJECTDIR}/src/text-table.o: src/text-table.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/text-table.o src/text-table.cpp
